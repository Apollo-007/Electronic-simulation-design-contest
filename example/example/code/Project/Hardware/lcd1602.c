...
#define  LCD1602_RS_DATA	   		HAL_GPIO_WritePin(LCD1602_Port,LCD1602_RS_Pin,GPIO_PIN_SET)		
#define  LCD1602_RS_CMD					HAL_GPIO_WritePin(LCD1602_Port,LCD1602_RS_Pin,GPIO_PIN_RESET)
/*****  GPIOB4  H:read;L:write  ******/
#define  LCD1602_RW_READ        HAL_GPIO_WritePin(LCD1602_Port,LCD1602_RW_Pin,GPIO_PIN_SET)
#define  LCD1602_RW_WRITE       HAL_GPIO_WritePin(LCD1602_Port,LCD1602_RW_Pin,GPIO_PIN_RESET)
/*****  GPIOB5    ******/
#define  LCD1602_E_HIGH         HAL_GPIO_WritePin(LCD1602_Port,LCD1602_EN_Pin,GPIO_PIN_SET)
#define  LCD1602_E_LOW          HAL_GPIO_WritePin(LCD1602_Port,LCD1602_EN_Pin,GPIO_PIN_RESET)

#define  LCD1602_DATA(x)				LCD1602_Port->ODR=(LCD1602_Port->ODR & 0x00ff) | (x<<8)
//############################################################
/* Commands*/
...
void LCD_Init(void)
{
	...
	HAL_GPIO_WritePin(LCD1602_Port, LCD1602_RS_Pin|LCD1602_RW_Pin|LCD1602_EN_Pin|LCD1602_D0_Pin
                          |LCD1602_D1_Pin|LCD1602_D2_Pin|LCD1602_D3_Pin|LCD1602_D4_Pin
                          |LCD1602_D5_Pin|LCD1602_D6_Pin|LCD1602_D7_Pin, GPIO_PIN_RESET);
	
	GPIO_InitStruct.Pin = LCD1602_RS_Pin|LCD1602_RW_Pin|LCD1602_EN_Pin|LCD1602_D0_Pin
                          |LCD1602_D1_Pin|LCD1602_D2_Pin|LCD1602_D3_Pin|LCD1602_D4_Pin
                          |LCD1602_D5_Pin|LCD1602_D6_Pin|LCD1602_D7_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LCD1602_Port, &GPIO_InitStruct);
